  ...
  return (
    <nav className={`navbar navbar-expand-lg bg-${props.mode} py-2`}>
      <div className="container-fluid">
        <a className={`navbar-brand heading text-${props.mode==="light"?"black":"white"}`} href="/">{props.title}</a>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <a className={`nav-link active text-${props.mode==="light"?"black":"white"}`} aria-current="page" href="/">{props.about}</a>
            </li>
