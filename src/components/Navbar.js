  ...
  return (
    <nav className={`navbar navbar-expand-lg bg-${props.mode} py-2`}>
      <div className="container-fluid">
        <Link className={`navbar-brand heading text-${props.mode==="light"?"black":"white"}`} to="/">{props.title}</Link>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <Link className={`nav-link active text-${props.mode==="light"?"black":"white"}`} aria-current="page" to="/about">{props.about}</Link>
            </li>
